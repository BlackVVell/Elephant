...
public class AuthorizationPageUserRoleTest {
    ...
    @Test
    void authorizationPageNonAuthedUser() {
        driver.get("http://127.0.0.1:7000/login");
        String url = driver.getCurrentUrl();
        assertEquals("http://127.0.0.1:7000/login", url);
    }

    @Test
    void authorizationPageNotCheckedUserTest() {
        driver.get("http://127.0.0.1:7000/login");
    ...
    @Test
    void authorizationPageBasicUserTest() {
        driver.get("http://127.0.0.1:7000/login");
        driver.findElement(By.linkText("Sign Up")).click();
        driver.findElement(By.id("email")).click();
        driver.findElement(By.id("email")).sendKeys("qwer@gmail.com");
    ...
    @Test
    void authorizationPageProUserTest() {
        driver.get("http://127.0.0.1:7000/login");
        driver.findElement(By.linkText("Sign Up")).click();
        driver.findElement(By.id("email")).click();
        driver.findElement(By.id("email")).sendKeys("qwer@gmail.com");
