...
public class ProfilePageUserRoleTest {
    ...
    @Test
    void homePageNonAuthedUserTest() {
        driver.get("http://127.0.0.1:7000/profile");
        String url = driver.getCurrentUrl();
        assertNotEquals("http://127.0.0.1:7000/profile", url);
    }

    @Test
    void homePageNotCheckedUserTest() {
        ...
        assertEquals("http://127.0.0.1:7000/profile", urlProfile);
    }

    @Test
    void homePageBasicUserTest() {
        driver.get("http://127.0.0.1:7000/login");
        driver.findElement(By.linkText("Sign Up")).click();
        driver.findElement(By.id("email")).click();
        driver.findElement(By.id("email")).sendKeys("qwer@gmail.com");
